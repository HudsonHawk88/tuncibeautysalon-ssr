            ...
            <Col xs={12} sm={12} md={12} lg={12}>
              <h2>
                {lang === "hu"
                  ...
                  : "Stornierung der Reservierung erfolgreich!"}
              </h2>
            </Col>
          </Row>
          <Row>
            {lang === "hu" ? (
              <Col xs={12} sm={12} md={12} lg={12}>
                A foglalását sikeresen törölte!
                <br />
              ...
              <Col xs={12} sm={12} md={12} lg={12}>
                ...
                Wir haben Sie auch per E-Mail über die Absage informiert!
                <br />
